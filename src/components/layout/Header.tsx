      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            {/* Desktop Navigation */}
            <nav className="hidden md:flex items-center justify-between flex-grow ml-6">
            <Link to="/" className="flex items-center space-x-2 flex-shrink-0">
              <Home className="h-7 w-7 sm:h-8 sm:w-8 text-blue-900" />
              <span className="text-xl sm:text-2xl font-bold text-blue-900">EstateIQ</span>
            </Link>
              <div className="flex items-center space-x-2 lg:space-x-6">
                {navLinks.map((link) => (
                  <Link
                    key={link.path}
                    to={link.path}
                    className={`flex items-center space-x-1 px-2 lg:px-3 py-2 rounded-md text-sm lg:text-base transition-colors ${
                      isActive(link.path)
              ...
              <div className="flex items-center space-x-2 lg:space-x-4 ml-4">
                <Link
                  to="/login"
                  className="px-3 lg:px-4 py-2 rounded-md text-blue-900 text-sm lg:text-base font-medium hover:bg-blue-50 transition-colors"
                >
                  Sign In
                </Link>
                <Link
                  to="/register"
                  className="px-3 lg:px-4 py-2 rounded-md bg-blue-900 text-white text-sm lg:text-base font-medium hover:bg-blue-800 transition-colors"
                >
                  Register
                </Link>
              </div>
